...
resource "aws_lb_listener" "this" {
  ...
  load_balancer_arn        = each.value.load_balancer_key != null ? aws_lb.this["${each.value.load_balancer_key}"].id : each.value.load_balancer_arn
...
resource "aws_lb_listener_rule" "this" {
  ...
  listener_arn = aws_lb_listener.this["${each.value.listener_arn_key}"].arn
  ...
  dynamic "action" {
    ...
    content {
      ...
      target_group_arn = aws_lb_target_group.this["${action.value.target_group_arn_key}"].arn
    }
  }
